...
Try {
	...
	If ($deploymentType -ine 'Uninstall' -and $deploymentType -ine 'Repair') {
		...
		$exitCode = Execute-MSI -Action "Install" -Path "$dirFiles\Teacher.msi" -AddParameters '/QN ADVANCE_OPTIONS=1 SECURE_MODE=1 PASSWORD=MSUTesting PASSWORD_CONFIRM=MSUTesting CHANNEL=347'
...
# KX7zUQIBAAIBAAIBAAIBAAIBADAxMA0GCWCGSAFlAwQCAQUABCBUm5MgiS937PKr
# 3fwxHFdCMJHdGWMQpYg1g0JW70K/7KCCGeEwggQUMIIC/KADAgECAgsEAAAAAAEv
...
# BgkqhkiG9w0BCQQxIgQgvIb4HKNCZWsE2ftENpn1NCkZLZkj2INP6JHleNVwIeIw
# DQYJKoZIhvcNAQEBBQAEggEAOOUk9lk86F9slhdU0VrF8OAXabSc1GXiHfEMg+G0
# ei2W1jfgBvt657/4wOiroJ0Fym3IAguhfwzFwJKCw5LG6COKAP4xh1ePPte02fn4
# VLP8YnuJhR3Kf9qDhmlBCjFKj9v9ySpoVZC0SQKK27fDd8lgD+xi69hqFL+S7OSS
# S86/xOVhSjn3ruv8RxIDdGyTC+7w7F6WF8cDCYXGcPysHhnSO/gCYG/ayRDmUc6Q
# otQlLCEWw+6hzWd7VhHdjoHjIIg+fp+WFrq+Ha7qWREr8fbanPUz5bqoZR+q7ezL
# TkLkAJPbMxikaGLsLiO3nekphqYDsiPD1bYlHb4DZ1jLPaGCAqIwggKeBgkqhkiG
...
# 9w0BCQMxCwYJKoZIhvcNAQcBMBwGCSqGSIb3DQEJBTEPFw0yMTAyMTUxOTE0NDla
# MCMGCSqGSIb3DQEJBDEWBBThwJDa0LZH5/xKUwjvlNdmKPoUvTCBnQYLKoZIhvcN
...
# GcxTQRQwDQYJKoZIhvcNAQEBBQAEggEAjzZXAAKV5ck+R2+Ckyp9HvKGXnac3Isp
# /UMkzALlSnaXOh7cTI4mnwqzOc513E8PPT1AZFez9iCxl61O/RsM/kVzWMaE8oaM
# yB+XOI5RtD6B6x0Bi0zuSZwj3Rulln/Eevo7Eif2crRmReF4+72rAVTJ1ExUcSfL
# rt86FP3x05B4QpVek30P+dXAY6nuSJAdNijvV2FzyZBE3ipCrIZrwoLrswC9Qhky
# D0W1xJkFibqhFpzD+5cfnpFcfDm/XXk8a157WziM/RINJu2cnSlJ5Deud0v21OXP
# QGiE19cIo/evseaE2ghaElCZiE8fi2ybvogEKy6GSiuETW2uEy5cVw==
